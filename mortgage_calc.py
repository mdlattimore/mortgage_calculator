...
print()
print()
console.rule("Loan Payment Calculator")
print()
print()
# User Input
...
Property Taxes: [bright_green]${tx:.2f}[/bright_green]
Insurance: [bright_green]${ie:.2f}[/bright_green]

Total Payment: [bright_green bold]${monthly_pi_payment + tx + ie:.2f}[/bright_green bold]"""
...
print()
print()
# table = (x for x in amortization_schedule(p, i*12, n))
